...
const Sandbox = z.object({
	...
	mounts: z.record(z.string(), z.object({
		...
		drive: mount.drive,
		mode: mount.mode === "read-only" ? "snapshot" : mount.mode ?? "read-write"
	}))).optional(),
