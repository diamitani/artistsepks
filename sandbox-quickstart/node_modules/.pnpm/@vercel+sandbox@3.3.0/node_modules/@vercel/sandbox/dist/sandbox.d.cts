...
type SandboxMountMode = "read-write" | "snapshot";
type SandboxMounts = Record<string, Drive | {
  drive: string;
...
//#endregion
export { Sandbox, SandboxMountMode, SandboxMounts, SerializedSandbox };
